/**
 * Canonical ulkoläksyt texts — verified against katekismus.fi and Raamattu 1992.
 *
 * chunk fields:
...
export const TEXTS = [
  // ── Isä meidän ─────────────────────────────────────────────────────────────
  // Source: katekismus.fi/isameidan/isameidan.html
  {
    id: 'isa_meidan',
    title: 'Isä meidän',
    ...
    chunks: [
      ...
      { id: 'im_25', text: 'Älä saata meitä',         type: 'imp'  },
  ...
  // Source: katekismus.fi/uskontunnustus/ (active past-tense verb forms)
  {
    id: 'apostolinen',
  ...
  // ── Kymmenen käskyä ─────────────────────────────────────────────────────────
  // Source: katekismus.fi/10kaskya/10kaskya.html
  ...
  // ── Herran siunaus ───────────────────────────────────────────────────────────
  // Source: Raamattu 1992 (4. Moos. 6:24–26)
  {
    id: 'herran_siunaus',
